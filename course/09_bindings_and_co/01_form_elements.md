...
- [La directive `bind:`](https://svelte.dev/docs/svelte/bind)
- [`bind:checked`](https://svelte.dev/docs/svelte/bind#input-bind:checked)
- [`bind:group`](https://svelte.dev/docs/svelte/bind#input-bind:group)
- [`<select>`](https://svelte.dev/docs/svelte/bind#select-bind:value)
