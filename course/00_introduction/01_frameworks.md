...
composants. Cela permet de créer des expériences interactives dans une page web plus facilement
qu'avec uniquement du JavaScript "vanille".

> L'expression "JavaScript vanille" fait référence à la manière d'écrire du code JavaScript sans
> l'utilisation de librairies utilitaires externes comme React, Svelte ou autre. Cela implique
> souvent l'utilisation des [APIs du
> DOM](https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API), qui peut vite s'avèrer
> laborieuse.
...
Les frameworks de composants – ou _meta-frameworks_ – sont pratiques pour créer des interfaces
...
- [SvelteKit](https://svelte.dev/docs/kit/) (basé sur Svelte)
...
> Vous devriez commencer à ressentir la [JavaScript
