...
défaut](https://svelte.dev/docs/kit/types#public-types-cookies), mais vous devrez tout de même
...
[En savoir plus sur ce chapitre](https://svelte.dev/docs/kit/load#cookies)
