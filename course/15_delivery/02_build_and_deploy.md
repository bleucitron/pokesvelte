...
> [ici](https://svelte.dev/docs/kit/adapter-node#environment-variables) et
> [là](https://svelte.dev/docs/kit/adapter-node#environment-variables).
...
- [Build](https://svelte.dev/docs/kit/building-your-app)
- [Adaptateurs](https://svelte.dev/docs/kit/adapters)
- [Serveurs Node](https://svelte.dev/docs/kit/adapter-node)
