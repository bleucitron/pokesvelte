...
- si le nom existe déjà, en utlisant `db.trainer.get(idOrName)` de `$lib/server/db`
...
[Plus d'infos sur ce chapitre](https://svelte.dev/docs/kit/form-actions#anatomy-of-an-action)
