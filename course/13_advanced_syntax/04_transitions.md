...
> transition](https://svelte.dev/docs/svelte/svelte-easing), appelée `ease`.
...
[CSS](https://svelte.dev/tutorial/svelte/custom-css-transitions) ou
[JS](https://svelte.dev/tutorial/svelte/custom-js-transitions)
