...
- [En savoir plus sur ce chapitre](https://svelte.dev/docs/svelte/each#Keyed-each-blocks)
- [Un autre exemple de ce problème](https://svelte.dev/tutorial/svelte/keyed-each-blocks)
