...
> [ici](https://svelte.dev/docs/kit/load#rerunning-load-functions-when-do-load-functions-rerun).
...
[`invalidate()`](https://svelte.dev/docs/kit/modules#$app-navigation-invalidate) du module
`$app/navigation`.
...
- [Infos d'url](https://svelte.dev/docs/kit/load#using-url-data)
- [Rejouer les fonctions `load`](https://svelte.dev/docs/kit/load#rerunning-load-functions)
- [`invalidate`](https://svelte.dev/docs/kit/modules#$app-navigation-invalidate)
